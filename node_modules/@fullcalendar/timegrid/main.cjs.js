    ...
    segIsInvisible, isDragging, isResizing, isDateSelecting) {
        ...
        return (common.createElement(common.Fragment, null,
            ...
            segRects.map(function (segRect) {
                ...
                var positionCss = tslib.__assign(tslib.__assign({}, _this.computeSegTopBottomCss(segRect.segInput)), (isMirror ? { left: 0, right: 0 } : _this.computeSegLeftRightCss(segRect)));
                return (common.createElement("div", { className: 'fc-timegrid-event-harness' + (segRect.stackForward > 0 ? ' fc-timegrid-event-harness-inset' : ''), key: instanceId, style: tslib.__assign({ visibility: segIsInvisible[instanceId] ? 'hidden' : '' }, positionCss) },
                    common.createElement(TimeColEvent, tslib.__assign({ seg: seg, isDragging: isDragging, isResizing: isResizing, isDateSelecting: isDateSelecting, isSelected: instanceId === eventSelection, isShort: (segRect.spanEnd - segRect.spanStart) < eventShortHeight }, common.getSegMeta(seg, todayRange, nowDate)))));
            })));
    };
